%\subsection*{User Interface Screenshots and description of the test cases}\label{appendix:testcases}
...
\begin{figure}[htbp]
    ...
    \end{subfigure}
    \caption{T1: User Interface Testcase}
    \label{fig:T1}
\end{figure}
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.25\textwidth}
        ...
        \label{subfig:t2b}
    \end{subfigure}
    \caption{T2: User Interface Testcase}
    \label{fig:T2}
\end{figure}
...
\begin{lstlisting}[language=java,label=t3a,lineskip={0pt}, caption=T3: Collecting the Time Needed to Conduct Experiment (a), basicstyle=\scriptsize, captionpos=b]
    String currentTime = new SimpleDateFormat("HH:mm:ss", Locale.getDefault()).format(new Date());
    LogMetaDataUseCase.getInstance().setMetaData(currentTime);
\end{lstlisting}

\begin{lstlisting}[language=java,label=t3b,lineskip={0pt}, caption=T3: Collecting the Time Needed to Conduct Experiment (b), basicstyle=\scriptsize, captionpos=b]
...
\begin{lstlisting}[language=java,label=t3b,lineskip={0pt}, caption=T4: Loading Data into the Artefact, basicstyle=\scriptsize, captionpos=b]
...
\begin{lstlisting}[language=java,label=t7c,lineskip={0pt}, caption=T7: Starting of Server and Client Threads, basicstyle=\scriptsize, captionpos=b]
...
\begin{figure}[htbp]
    ...
    \begin{subfigure}[b]{0.25\textwidth}
        ...
        \caption{ Questionair} % | Pixel 6 Pro
